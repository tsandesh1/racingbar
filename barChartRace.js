class barChartRace {
    ...
    constructor(options = {}) {
        ...
        this.tickDuration = options.tickDuration || 2000;
        this.delayDuration = options.delayDuration || 2000; //4000
        ...
        this.date = options.date || 'GW 0',
        this.info = options.info || {
            // 'GW 1': {
            //     image: 'images/gw-1.png',
            //     text: 'Sanam Dai started the season with a bang. His gameweek total was 101 WOW!!'
            // },
            // 'GW 12': {
            //     image: 'images/gw-12.png',
            //     text: 'defending Champion Sagar recorded his first win of the season by captaining Vardy.'
            // },
            // 'GW 26': {
            //     image: 'images/gw-26.png',
            //     text: 'top 16 participants qualified for Champions and Eutopa league!'
            // },
            // 'GW 31': {
            //     image: 'images/gw-31.png',
            //     text: 'Sagar with another incredible gameweek. Mind Blowing!!'
            // },
            // 'GW 38': {
            //     image: 'images/gw-38.png',
            //     text: 'Prasanta dai became the winner of Orlando Premier League. Congratulations bro!!'
            // }
        };
    ...
    updateInfoLabel() {
        if(this.info[this.date]) {
            this.infoText.html(`On ${this.date}, ${this.info[this.date].text}`);
